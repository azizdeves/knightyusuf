...
public class DariGlyphUtils {
	...
	public static int getRootChar(int c){
		...
		if(c==65263||c==65267||c==65268||c==65264)return 1609;
...
//		dariGlyphs.put(1569, new Glyph(1569, 65152, 65163, 65164, 65152, 2 ));
		dariGlyphs.put(1569, new Glyph(1569, 65152, 65152, 65152, 65152, 2 ));
		...
		dariGlyphs.put(1609, new Glyph(1740, 65263, 65267, 65268, 65264, 4 ));
