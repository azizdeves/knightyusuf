 ...
 * the License.
 */
package com.naitsoft.ihsan.client;
...
import com.naitsoft.ihsan.client.MyRequestFactory.MessageRequest;
import com.naitsoft.ihsan.shared.MessageProxy;

public class IhsanWidget extends Composite {
  ...
  interface IhsanUiBinder extends UiBinder<Widget, IhsanWidget> {
  }

  private static IhsanUiBinder uiBinder = GWT.create(IhsanUiBinder.class);
