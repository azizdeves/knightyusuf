...
public class ActionBarHelperBase extends ActionBarHelper
{
        ...
        /**
         * Action bar helper code to be run in {@link Activity#onCreateOptionsMenu(android.view.Menu)}. NOTE: This code
        ...
        /**
         * Returns the {@link android.view.ViewGroup} for the action bar on phones (compatibility action bar). Can
         ...
         * {@link android.view.MenuItem}. If the menu item ID is <code>menu_refresh</code>, the menu item's state can be
         * changed to show a loading spinner using
         * {@link android.support.v4.actionbar.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
         */
        private View addActionItemCompatFromMenuItem ( final MenuItem item )
        {
                ...
                actionButton
                        .setLayoutParams ( new ViewGroup.LayoutParams ( ( int ) mActivity.getResources ().getDimension (
